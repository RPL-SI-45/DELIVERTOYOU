...
<div class="container mt-5">
        <div class="jumbotron text-center">
            ...
            <a class="" href="/seller/status">Lihat Pesanan</a>
            <div class="text-center my-5">
            <a href="/seller/menu/input" class="">Tambah Makanan & Minuman Baru</a>
            <a href="/seller/menu" class="">Kelola Menu</a>
            <div class="text-center mt-3">
             <a href="/seller/orderhistory" class="">Lihat Riwayat Pesanan</a>
            </div>
            <a href="/seller/{{ auth()->user()->id }}/edit" class="">Edit Profil Toko</a>
            </div>
        </div>
    </div>
